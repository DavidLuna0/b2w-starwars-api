...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.david.b2wstarwars.resources")).paths(PathSelectors.any())
				.build()
				.apiInfo(apiInfo());
	}
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API de cadastro de plantes de Star Wars",
				...
				"Versão 1.0.0",
				"David Terms",
				new Contact("David Luna", "com/david", "david.luna.ads@gmail.com"),
